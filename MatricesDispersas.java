...
//        int cont2=5;
    ...
    public static int[][] MatrizAleatoria(){
        ...
        Random rand = new Random();
        int tam = rand.nextInt(10) + 1;
        System.out.println("Ingrese el tamaño de la matriz: ");
        System.out.println("Numero de filas: ");
        int filas= Integer.parseInt(JOptionPane.showInputDialog(null, "Numero de filas: "));
        int columnas= Integer.parseInt(JOptionPane.showInputDialog(null, "Numero de columnas: "));
        ...
        int numElementos = Math.min(numeros.size(), filas*columnas/2);
